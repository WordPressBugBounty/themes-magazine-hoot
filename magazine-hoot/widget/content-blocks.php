...
$query_args = apply_filters( 'maghoot_content_blocks_query', $query_args, $instance, $before_title, $title, $after_title );
...
<div class="content-blocks-widget-wrap content-blocks-pages <?php echo sanitize_html_class( $top_class ); ?> <?php echo sanitize_html_class( $bottom_class ); ?>">
	<div class="content-blocks-widget">
		...
		/* Display Title */
		if ( $title )
			echo wp_kses_post( apply_filters( 'maghoot_widget_title', $before_title . $title . $after_title, 'content-blocks', $title, $before_title, $after_title ) );
