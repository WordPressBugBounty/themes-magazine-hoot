...
// Link Text
$button_text = ( !empty( $button_text ) ) ? $button_text : maghoot_get_mod('read_more');
$button_text = ( empty( $button_text ) ) ? sprintf( __( 'Read More %s', 'magazine-hoot' ), '&rarr;' ) : $button_text;
?>
