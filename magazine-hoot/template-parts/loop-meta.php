...
if ( !is_front_page() && !is_singular() ) :
				...
				<div <?php hybridextend_attr( 'loop-meta', 'archive', 'hgrid-span-12' ); ?>>
					...
					<?php if ( is_author() ) : ?>
						<div class="loop-meta-gravatar"><?php
							...
							$gwidth = apply_filters( 'maghoot_loop_meta_gravatar', 0 );
							$gwidth = intval( $gwidth );
							$gwidth = ( !empty( $gwidth ) ) ? $gwidth : 150;
							add_filter( 'get_avatar', 'maghoot_ns_filter_avatar', 10, 6 );
							echo get_avatar( $author->ID, $gwidth, '404' );
							remove_filter( 'get_avatar', 'maghoot_ns_filter_avatar', 10, 6 );
							?></div>
					<?php endif; ?>
	...
	$maghoot_theme->loop_meta_displayed = true;
	endif;
					...
					<div class="hgrid">
						...
						<div <?php hybridextend_attr( 'loop-meta', '', 'hgrid-span-12' ); ?>>
							<div class="entry-header">
								...
								elseif ( !$hide_meta_info && 'top' == maghoot_get_mod( 'post_meta_location' ) && !is_attachment() && !( function_exists( 'is_buddypress' ) && is_buddypress() ) ):
