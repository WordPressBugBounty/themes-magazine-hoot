	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Maghoot_Premium_Customize_Section_Pro(
				$manager,
				'maghoot_premium',
				apply_filters( 'maghoot_theme_customize_section_pro', array(
					'title'    => esc_html__( 'Magazine Hoot Premium', 'magazine-hoot' ),
					'priority' => 1,
					'pro_text' => esc_html__( 'Premium', 'magazine-hoot' ),
					'pro_url'  => esc_url( admin_url('themes.php?page=magazine-hoot-welcome') ),
					'demo'     => 'https://demo.wphoot.com/magazine-hoot/',
					'docs'     => 'https://wphoot.com/support/',
					'rating'   => 'https://wordpress.org/support/theme/magazine-hoot/reviews/#new-post',
				) )
			)
		);
	}
