...
function maghoot_logo() {
	...
	if ( 'text' == $maghoot_logo || 'custom' == $maghoot_logo ) {
		...
		$title_icon = hybridextend_sanitize_fa( maghoot_get_mod( 'site_title_icon', NULL ) );
...
function maghoot_get_custom_text_logo() {
	...
	return apply_filters( 'maghoot_get_custom_text_logo', $title, $logo_custom );
}
endif;
		...
		<div <?php hybridextend_attr( 'header-part', 'supplementary', $menu_side_class ); ?>>
			<div class="hgrid">
				<div class="hgrid-span-12">
					...
					echo '</div>';
					if ( $menu_side ) {
						echo '<div ' . hybridextend_get_attr( 'menu-side-box', '', 'table-cell-mid inline-nav social-icons-invert' ) . '>';
...
function maghoot_meta_info_blocks( $args = '', $context = '', $editlink = true ) {
	...
	$blocks = apply_filters( 'maghoot_meta_info_blocks', $blocks, $context, $display, $editlink );
 ...
 * @return void
 */
if ( !function_exists( 'maghoot_display_404_content' ) ):
function maghoot_display_404_content() {
	echo esc_html( __( 'Apologies, but no entries were found.', 'magazine-hoot' ) );
}
endif;
add_action( 'maghoot_404_content', 'maghoot_display_404_content', 5 );
...
function maghoot_get_lite_slider( $type ) {
	...
	return apply_filters( 'maghoot_get_lite_slider_slides', $slides, $type, $data );
}
endif;
 ...
 * @return void
 */
if ( !function_exists( 'maghoot_ns_filter_avatar' ) ):
function maghoot_ns_filter_avatar( $avatar, $id_or_email, $size, $default, $alt, $args ) {
