...
function hybridextend_enum_social_profiles( $skype = true, $email = true ) {
	$social = array(
		...
		'fa-discord'        => __( 'Discord', 'hybrid-core' ),
		...
		'fa-tiktok'         => __( 'TikTok', 'hybrid-core' ),
		...
		'fa-whatsapp'       => __( 'Whatsapp', 'hybrid-core' ),
		'fa-wikipedia-w'    => __( 'Wikipedia', 'hybrid-core' ),
		'fa-windows'        => __( 'Windows', 'hybrid-core' ),
		'fa-wordpress'      => __( 'WordPress', 'hybrid-core' ),
		'fa-x-twitter'      => __( 'X (Twitter)', 'hybrid-core' ),
		'fa-square-x-twitter' => __( 'X (Twitter) Square', 'hybrid-core' ),
