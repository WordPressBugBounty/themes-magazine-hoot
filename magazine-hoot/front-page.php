			...
			foreach ( $sections as $key => $section ) :
				if ( empty( $section[ 'sortitem_hide' ] ) ):
					...
					elseif ( $key == 'content' )
						...
						$type = $key;
					$type = apply_filters( 'maghoot_frontpage_sections_switch', $type, $key, $sections );

					// Exit the loop except main content for a paged post list (blog)
					if ( $type != 'content-blog' && apply_filters( 'maghoot_fpg_paged_hidemodules', is_paged() ) )
						continue;
					...
					if ( $custom_template ):
						...
						switch( $type ):
							...
							case 'content-blog':
								...
								<div id="frontpage-page-content" <?php hybridextend_attr( 'frontpage-area', $key, 'frontpage-area frontpage-pagecontent frontpage-blog-content ' . esc_attr( $background_class ) ); ?>>
									...
									if ( !empty( $section['title'] ) )
										echo '<div class="hgrid frontpage-page-content-title"><div class="hgrid-span-12"><h3 class="maghoot-blogposts-title">' . wp_kses_post( $section['title'] ) . '</h3></div></div>';
									?>

									<div class="hgrid maghoot-blogposts main-content-grid">
										<div id="content-archive" class="content <?php echo maghoot_main_layout_class( 'content' ); ?>">
											<div id="content-wrap">
												...
												if ( have_posts() ) :
													...
													// Template modification Hook
													do_action( 'maghoot_loop_start', 'frontpage.php' );
													...
													// Template modification Hook
													do_action( 'maghoot_loop_end', 'frontpage.php' );
							...
							case 'content-page':
								...
								<div id="frontpage-page-content" <?php hybridextend_attr( 'frontpage-area', $key, 'frontpage-area frontpage-pagecontent frontpage-staticpage-content ' . esc_attr( $background_class ) ); ?>>
									...
									<div class="hgrid main-content-grid">
										<div id="content-staticpage" class="content <?php echo maghoot_main_layout_class( 'content' ); ?>">
											<div id="content-wrap">
												<?php
							...
							default:
								...
								do_action( 'maghoot_frontpage_sections', $type, $sections, $background_class, $context );
